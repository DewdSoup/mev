...
export type RiskCaps = {
  ...
  function minuteKeyUTC(d = new Date()): string {
  ...
  export class RiskManager {
    ...
    private minuteKey = minuteKeyUTC();
    ...
    private rollMinuteIfNeeded(now = new Date()) {
  ...
  export function loadRiskCapsFromEnv(env = process.env): RiskCaps {
  ...
  /** Small factory. */
  export function makeRisk(caps?: Partial<RiskCaps>) {
